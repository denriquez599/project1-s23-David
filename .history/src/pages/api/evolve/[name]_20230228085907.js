...
export default async function handler(req, res) {
    ...
    try {
        ...
        return res.json({"id":newData.data.id, "name": newData.data.name, "sprite": newData.data.sprites.front_default, "types": arr, "bgColor": colorData.data.color.name, "evolution":});
    }
    catch(error) {
        console.log(error);
    }
