...
export default async function handler(req, res) {
    ...
    try {
        ...
        return res.json({"id":data.data.id, "name": data.data.name, "sprite": data.data.sprites.front_default, "types": arr, "bgColor": colorData.data.color.name, "caught":caughtOrNot});
    } catch (e) {
        console.log(e);
    }
