                    ...
                    <div>
                        ...
                        <><div class="cardContainer shaker">
                                    <div class="pokeCard">
                                        ...
                                        <h2 class="foreground" style={{ textTransform: 'capitalize', fontFamily: 'Gill Sans', fontSize: '15px', fontWeight: 'lighter', position: 'absolute', bottom: '150px' }}>Has been caught!</h2>
                                        <div class="circle" style={{ backgroundColor: `${bgColor}` }} />
                                        <div class="background" style={{ backgroundColor: `${bgColor}` }} />
                                    </div>
                                </div><h2>{name} has been caught!</h2></>
                    ) : (
                        <><><div class="cardContainer shaker">
                                        <div class="pokeCard">
                                            <img class="pokePicture foreground" src={sprite} />
                                            ...
                                            <h2 style={{ position: 'absolute', bottom: '235px', fontSize: '20px' }}>#{id}</h2>
                                            <h2 class="foreground" style={{ textTransform: 'capitalize', fontFamily: 'Gill Sans', fontSize: '50px', fontWeight: 'normal', position: 'absolute', bottom: '150px', letterSpacing: '4px' }}>{name}</h2>
                                            <h2 class="foreground" style={{ textTransform: 'capitalize', fontFamily: 'Gill Sans', fontSize: '15px', fontWeight: 'lighter', position: 'absolute', bottom: '150px' }}>has broken free!</h2>
                                            <div class="circle" style={{ backgroundColor: `${bgColor}` }} />
                                            <div class="background" style={{ backgroundColor: `${bgColor}` }} />
                                        </div>
                                    </div></><h2>{name} broke free!</h2></>
                    )}
                    </div>
