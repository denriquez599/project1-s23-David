            ...
            {isValidating ? (
                ...
                <div class="cardContainer">
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Sans-Serif', fontSize:'35px'}}> {name} </h2>
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'mono', fontSize: '15px'}}>Type: {types.map(type => <span>{type} </span>)}</h2>
