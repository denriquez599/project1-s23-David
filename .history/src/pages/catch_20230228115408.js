...
export default function Name() {
            ...
            <div>
                    <form onSubmit={handleChange}>
                        <div class="inputForm">
                            ...
                            <br></br>
                            <label style={{fontSize: '35px'}} for="name">Which pokemon would you like to try to catch?</label>
                            <br></br>
                            <input style={{width:'150px'}} type="text" id="name" ref={inputRef}/>
                            <br></br>
                            <button type="submit" id="submit">Catch!</button>
                        </div>
    ...
    let { id, pokeName, sprite, types, bgColor, caught } = data
