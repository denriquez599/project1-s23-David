            ...
            {isValidating ? (
                ...
                <>
                    ...
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize: '15px', fontWeight:'lighter', position: 'absolute', bottom: '125px', left: '100px'}}>Level {level}</h2>
