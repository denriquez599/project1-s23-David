...
export default function Name() {
    ...
    if (!data) return (
        <>
            ...
            <div>
                    <form Which pokemon would you like to find?onSubmit={handleChange}>
                        <label style={{display: 'flex', alignItems: 'center'}} for="name">Hi there! </label>
                        <br></br>
                        <label for="name">Which pokemon would you like to find?</label>
                        <br></br>
