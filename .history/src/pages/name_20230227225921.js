        ...
        <>
            ...
            <div>
                    <form onSubmit={handleChange}>
                        <label class="inputForm" for="name">Hi there! </label>
                        <br></br>
                        <label class="inputForm" for="name">Which pokemon would you like to find?</label>
                        <input class="inputForm" type="text" id="name" ref={inputRef}/>
                        <button class="inputForm" type="submit" id="submit">Submit</button>
                    </form>
                    </div>
        </>
    )
