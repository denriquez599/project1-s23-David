                    ...
                    <div>
                        ...
                        <><div class="cardContainer shaker">
                                    <div class="pokeCard">
                                        ...
                                        <h2 class="foreground" style={{ textTransform: 'capitalize', fontFamily: 'Gill Sans', fontSize: '30px', fontWeight: 'lighter', position: 'absolute', bottom: '150px' }}>Has been caught!</h2>
