            ...
            {isValidating ? (
                ...
                <div class="cardContainer">
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'mono'}}> {name} </h2>
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'mono', fontSize: '20px'}}>Type: {types.map(type => <span>{type} </span>)}</h2>
