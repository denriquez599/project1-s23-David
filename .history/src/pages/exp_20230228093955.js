            ...
            {isValidating ? (
                ...
                <>
                    ...
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize: '15px', fontWeight:'normal', position: 'absolute', bottom: '125px', right: '650px'}}>{experience}xp</h2>
