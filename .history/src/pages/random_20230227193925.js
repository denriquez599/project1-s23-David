            ...
            {isValidating ? (
                ...
                <div class="cardContainer">
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize:'50px', fontWeight:'normal', position: 'absolute', bottom: '150px', letterSpacing: '3px'}}> {name} </h2>
