...
export default function Evolve() {
    const name1 = "pikachu"
    const { data, error, isLoading, isValidating } = useSWR(`/api/evolve/${name1}`, fetcher)
    ...
    const { data2, error2, isLoading2, isValidating2 } = useSWR(`/api/pokemon/pikachu`, fetcher)
    ...
    let {id, name2, sprite, types, bgColor } = data2;
