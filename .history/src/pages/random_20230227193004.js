            ...
            {isValidating ? (
                ...
                <div class="cardContainer">
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize: '15px', fontWeight:'lighter', paddingBottom:'35px}}>Type: {types.map(type => <span>{type} </span>)}</h2>
