        ...
        <>
            ...
            <form onSubmit={handleChange}>
                <div class="inputForm">
                    ...
                    <br></br>                       
                    <input style={{width:'150px'}} type="text" id="name" ref={nameRef}/>
                    <br></br>
                    <label style={{fontSize: '35px'}} for="level">What level are they? </label>
                    <br></br>                       
                    <input style={{width:'150px'}} type="text" id="level" ref={levelRef}/>
                    <p></p>
            ...
            {isValidating ? (
                ...
                <>
                    ...
                    <div class="pokeCard">
                        ...
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize: '15px', fontWeight:'lighter', position: 'absolute', bottom: '125px', left: '650px'}}>Level {level}</h2>
                        <h2 class="foreground" style={{textTransform: 'capitalize', fontFamily:'Gill Sans', fontSize: '15px', fontWeight:'lighter', position: 'absolute', bottom: '125px', right: '650px'}}>{experience}xp</h2>
